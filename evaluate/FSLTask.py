...
# ========================================================
#   Usefull paths
_datasetFeaturesFiles = {"sd198-20_wrn_v1": "./checkpoints/SD-198-20/WideResNet28_10_scan/last/novel_features.plk",
...
def setRandomStates(cfg):
    ...
    if not os.path.exists(rsFile):
        ...
        print("reloading random states from file....", rsFile)
