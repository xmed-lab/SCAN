...
def parse_args(script):
    ...
    parser.add_argument('--dataset', default='SD-198-20', help='SD-198-20/Derm7pt')
    parser.add_argument('--model', default='WideResNet28_10', help='model: WideResNet28_10/ResNet{18,34}/Conv{4,6}')
    parser.add_argument('--method', default='scan')
    parser.add_argument('--train_aug', default='False',
    ...
    parser.add_argument('--modelfile', default='../openselfsup/work_dirs/scan/sd198-20/wrn_v1/epoch_800.pth', help="model path")
    if script == 'train':
        ...
        parser.add_argument('--n_shot', default=5, type=int, help='number of shot')
        parser.add_argument('--n_way', default=5, type=int, help='number of classes')
        parser.add_argument('--dataset_file', default='SD-198-20', help='feature plk file')
        parser.add_argument('--save_dir', default='.', help='save dir of feature file')
