...
data_source_cfg = dict(
    ...
    memcached=False,
    mclient_path=None)
data_train_list = '../SkinLesionData/Derm7pt/base.json'
data_train_root = '../SkinLesionData/Derm7pt'
data_test_list = '../SkinLesionData/Derm7pt/base.json'
data_test_root = '../SkinLesionData/Derm7pt'
dataset_type = 'SCANDataset'

img_norm_cfg = dict(mean=[0.698, 0.595, 0.550], std=[0.265, 0.258, 0.262]) # Derm7pt
...
# CUDA_VISIBLE_DEVICES=3 bash tools/dist_train.sh configs/scan/derm7pt/wrn_v1.py 1
